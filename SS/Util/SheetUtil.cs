...
namespace Cydua.NPOI.SS.Util
{
    ...
    public class SheetUtil
    {
         ...
         *  {@link Cydua.NPOI.SS.UserModel.DataFormatter#formatCellValue(Cydua.NPOI.SS.UserModel.Cell)}
        ...
        //    str.AddAttribute(TextAttribute.SIZE, (float)font.FontHeightICydua.NPOInts);
