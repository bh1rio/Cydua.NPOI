...
namespace Cydua.NPOI.SS.UserModel
{
    ...
    public interface IRow : IEnumerable<ICell>
    {
        ...
        /// (255 for *.xls, 1048576 for *.xlsx)
        /// </throws>
        ICell CreateCell(int column, Cydua.NPOI.SS.UserModel.CellType type);
        ...
        /// <see cref="GetCell(int, Cydua.NPOI.SS.UserModel.MissingCellPolicy)"/>
        ICell GetCell(int cellnum);

        /// <summary>
        /// Returns the cell at the given (0 based) index, with the specified {@link Cydua.NPOI.SS.usermodel.Row.MissingCellPolicy}
        /// </summary>
        ...
        /// <see cref="ISheet.DefaultRowHeightICydua.NPOInts"/>
        /// </summary>
