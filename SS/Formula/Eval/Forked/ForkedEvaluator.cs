...
namespace Cydua.NPOI.SS.Formula.Eval.Forked
{
     ...
     * 90% of memory consumption is due to loading of the {@link HSSFWorkbook} or {@link Cydua.NPOI.xssf.usermodel.XSSFWorkbook}.
