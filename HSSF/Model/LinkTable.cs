...
namespace Cydua.NPOI.HSSF.Model
{
    ...
    public class LinkTable
    {
        ...
        public LinkTable(List<Cydua.NPOI.HSSF.Record.Record> inputList, int startIndex, WorkbookRecordList workbookRecordList, Dictionary<String, NameCommentRecord> commentRecords)
        {
     ...
     */
        ...
        {
            int index = 0;
            for (IEnumerator<Cydua.NPOI.HSSF.Record.Record> iterator = _workbookRecordList.GetEnumerator(); iterator.MoveNext();)
            {
                Cydua.NPOI.HSSF.Record.Record record = iterator.Current;
