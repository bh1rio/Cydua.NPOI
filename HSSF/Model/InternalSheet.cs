    ...
    public class InternalSheet
    {
        ...
        public InternalSheet CloneSheet()
        {
            ...
            for (int i = 0; i < this.records.Count; i++)
            {
                ...
                Cydua.NPOI.HSSF.Record.Record rec = (Cydua.NPOI.HSSF.Record.Record)((Cydua.NPOI.HSSF.Record.Record)rb).Clone();
        ...
        private InternalSheet(RecordStream rs)
        {
            ...
            else
            {
                ...
                while (rs.HasNext())
                {
                    Cydua.NPOI.HSSF.Record.Record rec = rs.GetNext();
                    if (rec is EOFRecord)
                    {
                        break;
                    }
        ...
        public static Cydua.NPOI.HSSF.Record.Record CreateBOF()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateIndex()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateCalcMode()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateCalcCount()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateRefMode()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateIteration()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateDelta()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateSaveRecalc()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreatePrintHeaders()
        {
        ...
        /// </summary>
        /// <see cref="Cydua.NPOI.HSSF.Record.DefaultRowHeightRecord"/>
        /// <see cref="Cydua.NPOI.HSSF.Record.Record"/>
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateWSBool()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateHCenter()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateVCenter()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreatePrintSetup()
        {
        ...
        protected Cydua.NPOI.HSSF.Record.Record CreateEOF()
        {
        ...
        public Cydua.NPOI.HSSF.Record.Record FindFirstRecordBySid(short sid)
        {
            ...
            return (Cydua.NPOI.HSSF.Record.Record)records[ix];
        }
        ...
        public int FindFirstRecordLocBySid(short sid)
        {
            ...
            {
                Object rb = records[i];
                if (!(rb is Cydua.NPOI.HSSF.Record.Record))
                {
                    continue;
                }
                Cydua.NPOI.HSSF.Record.Record record = (Cydua.NPOI.HSSF.Record.Record)rb;
                if (record.Sid == sid)
                {
                    return i;
                }
 ...
 */
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Cydua.NPOI.SS.UserModel.PanePosition activePane)
        {
            ...
            SelectionRecord sel = (SelectionRecord)FindFirstRecordBySid(SelectionRecord.sid);
            sel.Pane = (byte)Cydua.NPOI.SS.UserModel.PanePosition.LowerRight;
        ...
        public PaneInformation PaneInformation
        {
            get
            {
                ...
                return new Cydua.NPOI.SS.Util.PaneInformation(rec.X, rec.Y, rec.TopRow,
        ...
        public void VisitContainedRecords(RecordVisitor rv, int offset)
        {
            ...
            for (int k = 0; k < records.Count; k++)
            {
                ...
                else
                {
                    ...
                    ptv.VisitRecord((Cydua.NPOI.HSSF.Record.Record)record);
