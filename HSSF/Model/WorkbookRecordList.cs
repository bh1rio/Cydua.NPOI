...
namespace Cydua.NPOI.HSSF.Model
{
    ...
    {
        private List<Cydua.NPOI.HSSF.Record.Record> records = new List<Cydua.NPOI.HSSF.Record.Record>();
        ...
        public List<Cydua.NPOI.HSSF.Record.Record> Records
        {
            get { return records; }
        ...
        /// <summary>
        /// Gets the <see cref="Cydua.NPOI.HSSF.Record.Record"/> at the specified index.
        /// </summary>
        /// <value></value>
        public Cydua.NPOI.HSSF.Record.Record this[int index]
        {
            get { return (Cydua.NPOI.HSSF.Record.Record)records[index]; }
        ...
        public void Add(int pos, Cydua.NPOI.HSSF.Record.Record r)
        {
        ...
        public IEnumerator<Cydua.NPOI.HSSF.Record.Record> GetEnumerator()
        {
        ...
        public void Remove(Cydua.NPOI.HSSF.Record.Record record)
        {
