...
using Cydua.NPOI.SS.Formula.Udf;
...
namespace Cydua.NPOI.HSSF.Model
{
    ...
    public class InternalWorkbook
    {
         ...
         */
        public static InternalWorkbook CreateWorkbook(List<Cydua.NPOI.HSSF.Record.Record> recs)
        {
            //if (log.Check(POILogger.DEBUG))
            //    log.Log(DEBUG, "Workbook (Readfile) Created with reclen=",
            //           recs.Count);
            InternalWorkbook retval = new InternalWorkbook();
            List<Cydua.NPOI.HSSF.Record.Record> records = new List<Cydua.NPOI.HSSF.Record.Record>(recs.Count / 3);
            retval.records.Records = records;

            int k;
            for (k = 0; k < recs.Count; k++)
            {
                Cydua.NPOI.HSSF.Record.Record rec = (Cydua.NPOI.HSSF.Record.Record)recs[k];
        ...
        public static InternalWorkbook CreateWorkbook()
        {
            ...
            InternalWorkbook retval = new InternalWorkbook();
            List<Cydua.NPOI.HSSF.Record.Record> records = new List<Cydua.NPOI.HSSF.Record.Record>(30);
            retval.records.Records = records;
            ...
            for (int i = 0; i <= 7; i++)
            {
                Cydua.NPOI.HSSF.Record.Record rec = CreateFormat(i);
                retval.maxformatid = retval.maxformatid >= ((FormatRecord)rec).IndexCode ? retval.maxformatid : ((FormatRecord)rec).IndexCode;
 ...
 */
        ...
        public void SetSheetOrder(String sheetname, int pos)
        {
            ...
            Cydua.NPOI.HSSF.Record.Record removed = records[(pos0 + sheetNumber)];
 ...
 */
        public StyleRecord GetStyleRecord(int xfIndex)
        {
            ...
            for (int i = records.Xfpos; i < records.Count &&
                    !done; i++)
            {
                Cydua.NPOI.HSSF.Record.Record r = records[i];
        ...
        public int Serialize(int offset, byte[] data)
        {
            ...
            for (int k = 0; k < records.Count; k++)
            {
                ...
                Cydua.NPOI.HSSF.Record.Record record = records[k];
                // Let's skip RECALCID records, as they are only use for optimization
                if (record.Sid != RecalcIdRecord.sid || ((RecalcIdRecord)record).IsNeeded)
                {
                    int len = 0;
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateBOF()
        {
         ...
         */
        [Obsolete]
        protected Cydua.NPOI.HSSF.Record.Record CreateInterfaceHdr()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateMMS()
        {
         ...
         */
        [Obsolete]
        protected Cydua.NPOI.HSSF.Record.Record CreateInterfaceEnd()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateWriteAccess()
        {
            WriteAccessRecord retval = new WriteAccessRecord();
            String defaultUserName = "Cydua.NPOI";
            try
            {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateCodepage()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateDSF()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateTabId()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateFnGroupCount()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateWindowProtect()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreatePassword()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreatePasswordRev4()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateWindowOne()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateBackup()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateHideObj()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateDateWindow1904()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreatePrecision()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateRefreshAll()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateBookBool()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateFont()
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateExtendedFormat(int id)
     ...
     */
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateStyle(int id)
        {   // we'll need multiple editions
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateBoundSheet(int id)
        {
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateCountry()
        ...
        private static Cydua.NPOI.HSSF.Record.Record CreateExtendedSST()
        {
     ...
     */
         ...
         */
        public Cydua.NPOI.HSSF.Record.Record FindFirstRecordBySid(short sid)
        {
            for (IEnumerator iterator = records.GetEnumerator(); iterator.MoveNext();)
            {
                Cydua.NPOI.HSSF.Record.Record record = (Cydua.NPOI.HSSF.Record.Record)iterator.Current;
         ...
         */
        public Cydua.NPOI.HSSF.Record.Record FindNextRecordBySid(short sid, int pos)
        {
            int matches = 0;
            for (IEnumerator iterator = records.GetEnumerator(); iterator.MoveNext();)
            {
        ...
        */
        ...
        public PaletteRecord CustomPalette
        {
            get
            {
                ...
                if (palettePos != -1)
                {
                    Cydua.NPOI.HSSF.Record.Record rec = records[palettePos];
        ...
        public DrawingManager2 FindDrawingGroup()
        {
            ...
            {
                Cydua.NPOI.HSSF.Record.Record r = (Cydua.NPOI.HSSF.Record.Record)rit.Current;
