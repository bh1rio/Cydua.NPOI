...
namespace Cydua.NPOI.HSSF.EventUserModel
{
    /// <summary>
    ...
    public class HSSFRecordStream
    {
         ...
         */
        private Cydua.NPOI.HSSF.Record.Record rec = null;
        /**
         * The most recent record that we gave to the user
         */
        private Cydua.NPOI.HSSF.Record.Record lastRec = null;
        /**
        ...
        /// </summary>
        /// <returns></returns>
        public Cydua.NPOI.HSSF.Record.Record NextRecord()
        {
            Cydua.NPOI.HSSF.Record.Record r = null;
        ...
        /// </summary>
        /// <returns></returns>
        private Cydua.NPOI.HSSF.Record.Record GetBonusRecord()
        {
            if (bonusRecords != null)
            {
                Cydua.NPOI.HSSF.Record.Record r = (Cydua.NPOI.HSSF.Record.Record)bonusRecords[0];
        ...
        /// </summary>
        /// <returns></returns>
        private Cydua.NPOI.HSSF.Record.Record GetNextRecord()
        {
            Cydua.NPOI.HSSF.Record.Record toReturn = null;
            ...
            if (in1.HasNextRecord)
            {
                ...
                if (sid != ContinueRecord.sid)
                {
                    ...
                    Cydua.NPOI.HSSF.Record.Record[] recs = RecordFactory.CreateRecord(in1);
