...
namespace Cydua.NPOI.HSSF.EventUserModel
{
    ...
    public abstract class AbortableHSSFListener : IHSSFListener
    {
        ...
        public virtual void ProcessRecord(Cydua.NPOI.HSSF.Record.Record record)
        {
        }
        ...
        /**
          ...
          */
        public abstract short AbortableProcessRecord(Cydua.NPOI.HSSF.Record.Record record);
    }
}