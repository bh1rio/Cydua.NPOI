...
namespace Cydua.NPOI.HSSF.EventUserModel
{
    ...
    public class EventWorkbookBuilder
    {
        ...
        {
            List<Cydua.NPOI.HSSF.Record.Record> wbRecords = new List<Cydua.NPOI.HSSF.Record.Record>();
        ...
        public class SheetRecordCollectingListener : IHSSFListener
        {
            ...
            /// </summary>
            /// <param name="record">The record.</param>
            public void ProcessRecordInternally(Cydua.NPOI.HSSF.Record.Record record)
            {
