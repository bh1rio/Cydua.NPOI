...
using Cydua.NPOI.HSSF.Record;
    ...
    public class DVConstraint : IDataValidationConstraint
    {
         ...
         * 
         * @param validationType one of {@link Cydua.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#ANY},
         * {@link Cydua.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#DECIMAL},
         * {@link Cydua.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#INTEGER},
         * {@link Cydua.NPOI.SS.UserModel.DataValidationConstraint.ValidationType#TEXT_LENGTH}
         * @param comparisonOperator any constant from {@link Cydua.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
         ...
         * 
         * @param comparisonOperator constant from {@link Cydua.NPOI.SS.UserModel.DataValidationConstraint.OperatorType} enum
        ...
        /* (non-Javadoc)
         * @see Cydua.NPOI.HSSF.UserModel.DataValidationConstraint#getValidationType()
         */
        ...
        /* (non-Javadoc)
         * @see Cydua.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula1()
         */
        ...
        /* (non-Javadoc)
         * @see Cydua.NPOI.HSSF.UserModel.DataValidationConstraint#getFormula2()
         */
