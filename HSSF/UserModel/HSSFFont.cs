...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFFont : Cydua.NPOI.SS.UserModel.IFont
    {
        ...
        /// use the GetFontHeightICydua.NPOInts which matches to the familiar 10, 12, 14 etc..
        /// </summary>
        ...
        {
            return "Cydua.NPOI.HSSF.UserModel.HSSFFont{" +
                     font +
                    "}";
        }
