...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    public class HSSFClientAnchor : HSSFAnchor, IClientAnchor
    {
        ...
        public float GetAnchorHeightInPoints(Cydua.NPOI.SS.UserModel.ISheet sheet)
        {
            int y1 = Dy1;
            int y2 = Dy2;
        ...
        /// <returns></returns>
        private float GetRowHeightInPoints(Cydua.NPOI.SS.UserModel.ISheet sheet, int rowNum)
        {
            Cydua.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowNum);
            if (row == null)
