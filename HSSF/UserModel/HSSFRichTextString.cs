...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,Cydua.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, Cydua.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(Cydua.NPOI.SS.UserModel.IFont font)
        {
