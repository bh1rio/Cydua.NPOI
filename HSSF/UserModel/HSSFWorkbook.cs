...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public Cydua.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : Cydua.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private Cydua.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = Cydua.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public Cydua.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public Cydua.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public Cydua.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
        ...
        public Cydua.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public Cydua.NPOI.SS.UserModel.Font FindFont(Cydua.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 Cydua.NPOI.SS.UserModel.FontSuperScript typeOffset, Cydua.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public Cydua.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         FontSuperScript typeOffset, FontUnderlineType underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                Cydua.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public Cydua.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public Cydua.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public Cydua.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
        ...
        /**
         * Closes the underlying {@link Cydua.NPOIFSFileSystem} from which
        ...
        public override void Write(Stream stream)
        {
            ...
            Cydua.NPOI.HPSF.CustomProperties cp = this.DocumentSummaryInformation.CustomProperties;
            if(cp==null)
            {
                cp= new Cydua.NPOI.HPSF.CustomProperties();
            }
            cp.Put("Generator", "Cydua.NPOI");
            ...
            this.SummaryInformation.ApplicationName = "Cydua.NPOI";
 ...
 */
        ...
        public Cydua.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public Cydua.NPOI.SS.UserModel.IName GetNameAt(int nameIndex)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public Cydua.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public Cydua.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, Cydua.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case Cydua.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case Cydua.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case Cydua.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case Cydua.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case Cydua.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case Cydua.NPOI.SS.UserModel.PictureType.DIB:
