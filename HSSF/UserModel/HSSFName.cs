...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:Cydua.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, Cydua.NPOI.SS.Formula.FormulaType.NamedRange, SheetIndex);
