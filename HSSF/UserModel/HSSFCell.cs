 ...
 */
        ...
        public void SetCellValue(IRichTextString value)
        {
            ...
            if (value.Length > Cydua.NPOI.SS.SpreadsheetVersion.EXCEL97.MaxTextLength)
            {
 ...
 */
        ...
        public override String ToString()
        {
            switch (CellType)
            {
                ...
                case CellType.Error:
                    return Cydua.NPOI.SS.Formula.Eval.ErrorEval.GetText(((BoolErrRecord)_record).ErrorValue);
                case CellType.Formula:
                    return CellFormula;
                case CellType.Numeric:
