...
namespace Cydua.NPOI.HSSF.UserModel
{
     ...
     * 
     * <pre>
     *      multipler = GroupHeightICydua.NPOInts / heightOfGroup
     * </pre>
     * 
     * The height of the Group Is calculated fairly simply by calculating the
     * difference between the y coordinates of the bounding box of the shape.  The
     * height of the Group can be calculated by using a convenience called
     * <c>HSSFClientAnchor.GetAnchorHeightICydua.NPOInts()</c>.
     * </blockquote>
     *
    ...
    public class EscherGraphics : IDisposable
    {
        ...
        private HSSFFont MatchFont(Font font)
        {
            ...
            HSSFFont hssfFont = (HSSFFont)workbook.FindFont(bold ? (short)Cydua.NPOI.SS.UserModel.FontBoldWeight.Bold : (short)Cydua.NPOI.SS.UserModel.FontBoldWeight.Normal,
                        hssfColor.Indexed,
                        (short)(font.Size * 20),
                        font.Name,
                        italic,
                        false,
                        (short)Cydua.NPOI.SS.UserModel.FontSuperScript.None,
                        (byte)Cydua.NPOI.SS.UserModel.FontUnderlineType.None
                        );
            if (hssfFont == null)
            {
                hssfFont = (HSSFFont)workbook.CreateFont();
                hssfFont.Boldweight = (short)(bold ? Cydua.NPOI.SS.UserModel.FontBoldWeight.Bold : 0);
         ...
         * 
         * This Draws the polygon, with <c>Cydua.NPOInt</c> line segments.
         * The first <c>Cydua.NPOInt - 1</c> line segments are
         ...
         * @param Cydua.NPOInts the total number of points in the polygon.
