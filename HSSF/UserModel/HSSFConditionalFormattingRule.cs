...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    using Cydua.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)Cydua.NPOI.SS.UserModel.ComparisonOperator.Between:
                        case (byte)Cydua.NPOI.SS.UserModel.ComparisonOperator.NotBetween:
