...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFPrintSetup :Cydua.NPOI.SS.UserModel.IPrintSetup
    {
        ...
        public Cydua.NPOI.SS.UserModel.DisplayCellErrorType CellError
        {
            get { return (Cydua.NPOI.SS.UserModel.DisplayCellErrorType)printSetupRecord.CellError; }
