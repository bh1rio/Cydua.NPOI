...
using Cydua.NPOI.HSSF.Record.Aggregates;
using Cydua.NPOI.HSSF.Record.AutoFilter;
...
namespace Cydua.NPOI.HSSF.UserModel
{
    /// <summary>
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : Cydua.NPOI.SS.UserModel.ISheet
    {
        /**
        ...
        private Dictionary<int, Cydua.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="Cydua.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, Cydua.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="Cydua.NPOI.HSSF.UserModel.HSSFWorkbook(Cydua.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public Cydua.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            Cydua.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public Cydua.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public Cydua.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        private class RecordVisitor1 : RecordVisitor
        {
            ...
            public void VisitRecord(Cydua.NPOI.HSSF.Record.Record r)
            {
                if (!(r is DVRecord))
                {
                    return;
        ...
        /// <summary>
        /// Get the visibility state for a given column.F:\Gloria\�о�\�ļ���ʽ\Cydua.NPOI\src\Cydua.NPOI\HSSF\Util\HSSFDataValidation.cs
        /// </summary>
        ...
        [Obsolete]
        public int AddMergedRegion(Cydua.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(Cydua.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public Cydua.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    Cydua.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new Cydua.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="Cydua.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public Cydua.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public Cydua.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public Cydua.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, Cydua.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, Cydua.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, Cydua.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, Cydua.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, Cydua.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                Cydua.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                Cydua.NPOI.SS.Util.CellRangeAddress region = (Cydua.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(Cydua.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    Cydua.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, Cydua.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, Cydua.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public Cydua.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(Cydua.NPOI.SS.UserModel.MarginType margin)
        {
            switch (margin)
            {
        ...
        public void SetMargin(Cydua.NPOI.SS.UserModel.MarginType margin, double size)
        {
            switch (margin)
            {
                case MarginType.FooterMargin:
     ...
     */
        ...
        public void SetDefaultColumnStyle(int column, Cydua.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        /// </summary>
        public Cydua.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                Cydua.NPOI.SS.UserModel.IWorkbook wb = Workbook;
        ...
        // Copy sheet based on logic posted by "brimars" on 2011-04-29 at http://Cydua.NPOI.codeplex.com/discussions/254536
