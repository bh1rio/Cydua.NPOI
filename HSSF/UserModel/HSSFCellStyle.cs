...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    public class HSSFCellStyle : ICellStyle
    {
        ...
        private Cydua.NPOI.HSSF.Model.InternalWorkbook _workbook = null;
        ...
        /// <param name="rec">The record.</param>
        /// <param name="workbook">The workbook.</param>
        public HSSFCellStyle(short index, ExtendedFormatRecord rec, Cydua.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
        ...
        /// <returns></returns>
        public String GetDataFormatString(Cydua.NPOI.HSSF.Model.InternalWorkbook workbook)
        {
            HSSFDataFormat format = new HSSFDataFormat(workbook);
        ...
        public void SetFont(Cydua.NPOI.SS.UserModel.IFont font)
        {
