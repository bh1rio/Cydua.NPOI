...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    public class HSSFOptimiser
    {
        ...
        public static void OptimiseFonts(HSSFWorkbook workbook)
        {
            ...
            {
                Cydua.NPOI.SS.UserModel.ISheet s = workbook.GetSheetAt(sheetNum);
                ...
                foreach (IRow row in s) 
                {
                    ...
                    foreach (ICell cell in row) 
                    {
                        ...
                        if (cell.CellType == Cydua.NPOI.SS.UserModel.CellType.String)
                        {
            ...
            for (int sheetNum = 0; sheetNum < workbook.NumberOfSheets; sheetNum++)
            {
                ...
                foreach(IRow row in s)
                {
                    ...
                    foreach (ICell cell in row)
                    {
                        ...
                        Cydua.NPOI.SS.UserModel.ICellStyle newStyle = workbook.GetCellStyleAt(
                                newPos[oldXf]
                        );
