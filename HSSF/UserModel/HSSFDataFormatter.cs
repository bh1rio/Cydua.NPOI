...
namespace Cydua.NPOI.HSSF.UserModel
{
     ...
     * codes, etc.
     * 
     * Internally, formats will be implemented using subclasses of <see cref="Cydua.NPOI.SS.Util.FormatBase"/>
     * such as <see cref="Cydua.NPOI.SS.Util.DecimalFormat"/> and <see cref="Cydua.NPOI.SS.Util.SimpleDateFormat"/>. Therefore the
