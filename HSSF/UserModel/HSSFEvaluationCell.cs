...
namespace Cydua.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationCell : IEvaluationCell
    {
        ...
        private Cydua.NPOI.SS.UserModel.ICell _cell;

        public HSSFEvaluationCell(Cydua.NPOI.SS.UserModel.ICell cell, IEvaluationSheet evalSheet)
        {
            _cell = cell;
            _evalSheet = evalSheet;
        }
        public HSSFEvaluationCell(Cydua.NPOI.SS.UserModel.ICell cell)
        {
            _cell = cell;
        ...
        {
            Cydua.NPOI.SS.UserModel.ICell cellb = ((HSSFEvaluationCell)obj)._cell;
        ...
        public Cydua.NPOI.SS.UserModel.ICell HSSFCell
        {
            get
            {
                return _cell;
        ...
        public Cydua.NPOI.SS.UserModel.CellType CellType
        {
            get
            {
