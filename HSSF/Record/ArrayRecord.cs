...
namespace Cydua.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private Cydua.NPOI.SS.Formula.Formula _formula;
            ...
            : base(in1)
        {
            ...
            _formula = Cydua.NPOI.SS.Formula.Formula.Read(formulaTokenLen, in1, totalFormulaLen);
        }
        public ArrayRecord(Cydua.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
