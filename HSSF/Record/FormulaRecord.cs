 ...
 */
    internal class SpecialCachedValue
    {
        ...
        public Cydua.NPOI.SS.UserModel.CellType GetValueType()
        {
            int typeCode = GetTypeCode();
            switch (typeCode)
            {
                case STRING: return Cydua.NPOI.SS.UserModel.CellType.String;
                case BOOLEAN: return Cydua.NPOI.SS.UserModel.CellType.Boolean;
                case ERROR_CODE: return Cydua.NPOI.SS.UserModel.CellType.Error;
                case EMPTY: return Cydua.NPOI.SS.UserModel.CellType.String; // is this correct?
            }
    ...
    public class FormulaRecord : CellRecord
    {
        ...
        [NonSerialized]
        private Cydua.NPOI.SS.Formula.Formula field_8_parsed_expr;
        ...
        */
        ...
        {
            field_8_parsed_expr = Cydua.NPOI.SS.Formula.Formula.Create(Ptg.EMPTY_PTG_ARRAY);
        }
        ...
        public FormulaRecord(RecordInputStream in1):base(in1)
        {
                ...
                field_8_parsed_expr = Cydua.NPOI.SS.Formula.Formula.Read(field_7_expression_len, in1,in1.Available());
        }
        /**
 ...
 */
        ...
        {
            field_8_parsed_expr = Cydua.NPOI.SS.Formula.Formula.Create(ptgs);
        }
        ...
        public Ptg[] ParsedExpression
        {
            ...
            set { field_8_parsed_expr = Cydua.NPOI.SS.Formula.Formula.Create(value); }
        }
        public Cydua.NPOI.SS.Formula.Formula Formula
        {
            get
            {
        ...
        public Cydua.NPOI.SS.UserModel.CellType CachedResultType
        {
            get
            {
                if (specialCachedValue == null)
                {
                    return Cydua.NPOI.SS.UserModel.CellType.Numeric;
                }
                return (Cydua.NPOI.SS.UserModel.CellType)specialCachedValue.GetValueType();
            }
        }
