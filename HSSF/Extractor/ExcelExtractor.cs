...
namespace Cydua.NPOI.HSSF.Extractor
{
    ...
    public class ExcelExtractor : POIOLE2TextExtractor, IExcelExtractor
    {
                    ...
                    for (int j = firstRow; j <= lastRow; j++)
                    {
                        ...
                        for (int k = firstCell; k < lastCell; k++)
                        {
                            ...
                            else
                            {
                                ...
                                Cydua.NPOI.SS.UserModel.IComment comment = cell.CellComment;
        ...
        /// <returns></returns>
        public static String ExtractHeaderFooter(Cydua.NPOI.SS.UserModel.IHeaderFooter hf)
        {
            StringBuilder text = new StringBuilder();
